...
alpha0.015 <- pAddBinplot(p=seq(0.35,0.65,by=0.0001),alpha=-0.015,
                       plot_title="and when alpha=-0.015",p_seq= T)
...
grid.arrange(alpha0.015,alpha0.003,alpha0.005,alpha0.008,nrow=2,
