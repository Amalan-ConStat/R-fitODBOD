...
```{r Uniform Binomial Distribution plotting,fig.align='center',fig.width=9,fig.height=7}
brv<-0:10
...
```{r Triangular Binoimal Distribution plotting,fig.align='center',fig.width=9,fig.height=7}
brv<-seq(0,15,by=1)
...
* `pCOMPBin` - plot function to COM Poisson Binomial Distribution.
* `pCorrBin` - plot function to Correlated Binomial Distribution.
* `pMultiBin` - plot function to Multiplicative Binomial Distribution.
...
```{r Correlated Binomial distribution plot function}
