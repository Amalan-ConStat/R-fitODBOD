...
```{r Uniform Binomial Distribution,fig.align='center',fig.width=9,fig.height=7}
brv<-0:10
...
```{r Triangular Binomial Distribution,fig.align='center',fig.width=9,fig.height=7}
brv<-seq(0,15,by=1)
...
* `dCOMPBin` - plot function to COM Poisson Binomial Distribution.
* `dCorrBin` - plot function to Correlated Binomial Distribution.
* `dMultiBin` - plot function to Multiplicative Binomial Distribution.
...
* p is the probability value in between zero and one.
* cov is the covaraince value in between negative infinity and positive infinity.
