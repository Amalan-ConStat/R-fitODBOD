...
```{r plotting Expected frequencies with actual frequency for BMD,include=FALSE, warning=FALSE,eval=FALSE}
...
```{r plotting that dataset for BMD,fig.align='center',fig.height=7,fig.width=9,echo=FALSE,eval=FALSE}
